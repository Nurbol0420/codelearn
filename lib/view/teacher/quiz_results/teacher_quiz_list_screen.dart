...
class _TeacherQuizListScreenState extends State<TeacherQuizListScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      final quizzes = instructorId == null
          ? <Quiz>[]
          : await _repo.getQuizzesByInstructor(instructorId);
      setState(() {
        _quizzes = quizzes;
        _isLoading = false;
      });
                ...
                delegate: SliverChildBuilderDelegate((context, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '${quiz.questions.length} ${l10n.questionsCount}',
                                style: TextStyle(
                                  fontSize: 12,
                      ...
                      onTap: () =>
                          Get.to(() => TeacherQuizResultsScreen(quiz: quiz)),
                    ),
                  );
